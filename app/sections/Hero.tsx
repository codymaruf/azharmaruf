  ...
  return (
    <div ref={heroRef} className="relative min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-100 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        {/* Top Badge */}
        <div 
          className={`inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-amber-200/50 shadow-lg mb-8 transition-all duration-1000 ${
        ...
        <div className="max-w-5xl">
          ...
          {/* Subheadline */}
          <p 
            className={`text-xl md:text-2xl text-gray-700 leading-relaxed mb-4 max-w-3xl transition-all duration-1000 delay-400 ${
              isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
          ...
          <p 
            className={`text-lg md:text-xl text-gray-600 leading-relaxed mb-12 max-w-3xl transition-all duration-1000 delay-500 ${
              isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
          ...
          {/* CTA Buttons */}
          <div 
            className={`flex flex-wrap gap-4 mb-16 transition-all duration-1000 delay-700 ${
              isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
          ...
          >
            {services.map((service, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="group relative p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-amber-100 hover:border-amber-300 transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer"
                  style={{
